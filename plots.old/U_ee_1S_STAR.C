...
void U_ee_1S_STAR()
{
	...
	TFile *fileUps_ee = TFile::Open("../data/PY_Upsilon_mumu.root");
	...
	cout << "bin 0: " << corrUps_ee_bin_own[0] << endl;
	cout << "bin 1: " << corrUps_ee_bin_own[1] << endl;
	cout << "bin 2: " << corrUps_ee_bin_own[2] << endl;
	cout << "bin 3: " << corrUps_ee_bin_own[3] << endl;
	...
	ratio_1S->GetYaxis()->SetRangeUser(0.,7.);
