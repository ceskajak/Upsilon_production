...
void d_pT()
{
	...
	TTreeReaderValue<Double_t> HE_d1_pT2(readHE_Ups2, "d1_pT");
	TTreeReaderValue<Double_t> HE_d2_pT2(readHE_Ups2, "d2_pT");
	TTreeReaderValue<Double_t> HE_d1_pT4(readHE_Ups4, "d1_pT");
	TTreeReaderValue<Double_t> HE_d2_pT4(readHE_Ups4, "d2_pT");
	TTreeReaderValue<Double_t> HE_d1_pT20(readHE_Ups20, "d1_pT");
	TTreeReaderValue<Double_t> HE_d2_pT20(readHE_Ups20, "d2_pT");

	TH1D *PY = new TH1D("PY", "", 100, 0, 50);
	...
	TH1D *HE2 = new TH1D("HE2", "", 100, 0, 50);
	...
	TH1D *HE4 = new TH1D("HE4", "", 100, 0, 50);
	...
	TH1D *HE20 = new TH1D("HE20", "", 100, 0, 50);
	while(readHE_Ups20.Next())
	{			
		HE20->Fill(*HE_d1_pT20);
		HE20->Fill(*HE_d2_pT20);
	}
	HE20->Scale(1/(HE20->GetEntries()));

	TCanvas* c1 = new TCanvas("c1", "d_pT Ups spectrum", 800, 600);
	c1->SetLogy();
	...
	leg->AddEntry(PY->DrawCopy("same"), "PYTHIA 8", "p");
	...
	c1->cd();
	c1->Print("../output/d_pT_Ups.png", "png");
}
