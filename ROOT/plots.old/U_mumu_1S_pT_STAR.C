...
void U_mumu_1S_pT_STAR()
{
	...
	{
		if (*Ups_mumu_d1_pT > 0.2 && abs(*Ups_mumu_d1_eta) < 1 && *Ups_mumu_d2_pT > 0.2 && abs(*Ups_mumu_d2_eta) < 1 && *Ups_mumu_pT > 4 && *Ups_mumu_1S == 1)
		{
	...
	c2->cd();
	c2->Print("../output.general/Ups_mumu_1S_pT_STAR_500.png", "png");
}
