...
void complete_H4()
{
	...
	TFile *fileUps_ee = TFile::Open("../data/HE_Upsilon_4.root");
	...
	leg_ee_all_own->AddEntry(gr_ee_all_own, "HERWIG 7, kT = 4 GeV", "f");
	...
	c_ee_all_own->Print("../output/all_own_HE4.png", "png");
	...
	leg_ee_all_STAR->AddEntry(gr_ee_all_STAR, "HERWIG 7, kT = 4 GeV", "f");
	...
	c_ee_all_STAR->Print("../output/all_STAR_HE4.png", "png");
	...
	leg_ee_1S_own->AddEntry(gr_ee_1S_own, "HERWIG 7, kT = 4 GeV", "f");
	...
	c_ee_1S_own->Print("../output/1S_own_HE4.png", "png");
	...
	leg_ee_1S_STAR->AddEntry(gr_ee_1S_STAR, "HERWIG 7, kT = 4 GeV", "f");
	...
	c_ee_1S_STAR->Print("../output/1S_STAR_HE4.png", "png");
	...
	leg_ee_1S_pT_own->AddEntry(gr_ee_1S_pT_own, "HERWIG 7, kT = 4 GeV", "f");
	...
	c_ee_1S_pT_own->Print("../output/1S_pT_own_HE4.png", "png");
	...
	leg_ee_1S_pT_STAR->AddEntry(gr_ee_1S_pT_STAR, "HERWIG 7, kT = 4 GeV", "f");
	...
	c_ee_1S_pT_STAR->Print("../output/1S_pT_STAR_HE4.png", "png");
	...
	leg_ee_2S_own->AddEntry(hist_1S_own, "HERWIG 7, kT = 4 GeV, #Upsilon(1S)", "p");
	leg_ee_2S_own->AddEntry(hist_2S_own, "HERWIG 7, kT = 4 GeV,  #Upsilon(2S)", "p");

	hist_1S_own->Draw("P E1");
	hist_2S_own->Draw("same P E1");
	leg_ee_2S_own->Draw("same");
	c_ee_2S_own->Print("../output/2S_own_HE4.png", "png");
	...
	c_ee_2S_STAR->Print("../output/2S_STAR_HE4.png", "png");
}
