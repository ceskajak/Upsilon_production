...
do
	...
	sed -i "s,cd .,cd /home/ceskajak/Ups/Herwig/rivet_MinBias/runs/run00$i/,g" rivet_MinBias00$i.sh
...
do
	...
	sed -i "s,cd .,cd /home/ceskajak/Ups/Herwig/rivet_MinBias/runs/run0$i/,g" rivet_MinBias0$i.sh
...
do
	...
	sed -i "s,cd .,cd /home/ceskajak/Ups/Herwig/rivet_MinBias/runs/run$i/,g" rivet_MinBias$i.sh
