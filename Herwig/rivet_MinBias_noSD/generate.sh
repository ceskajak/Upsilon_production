...
do
	...
	sed -i "s,cd .,cd /home/ceskajak/Ups/Herwig/rivet_MinBias_noSD/runs/run00$i/,g" rivet_MinBias00$i.sh
...
do
	...
	sed -i "s,cd .,cd /home/ceskajak/Ups/Herwig/rivet_MinBias_noSD/runs/run0$i/,g" rivet_MinBias0$i.sh
...
do
	...
	sed -i "s,cd .,cd /home/ceskajak/Ups/Herwig/rivet_MinBias_noSD/runs/run$i/,g" rivet_MinBias$i.sh
